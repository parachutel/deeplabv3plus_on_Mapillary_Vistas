...
def create_mvd_label_colormap():
  """Creates a label colormap used in Mapillary segmentation benchmark.
...
def create_label_colormap(dataset=_MVD):
  ...
  if dataset == _PASCAL:
    ...
    return create_mvd_label_colormap()
  else:
    raise ValueError('Unsupported dataset.')


def label_to_color_image(label, dataset=_MVD):
