...
IMAGE_FOLDER="${MVD_ROOT}/JPEGImages"
LIST_FOLDER="${MVD_ROOT}/ImageSets/Segmentation"

echo "Converting MVD dataset..."
python ./build_mapillary_vistas_data.py \
